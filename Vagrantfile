...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell" do |s|
    s.env = {"CURATOR_DB_NAME" => "keyword_test",
             "CURATOR_DB_USER" => "keyword_test",
             "CURATOR_DB_PASS" => "test_dbpass",
             "CURATOR_DB_HOST" => "localhost",
             "CURATOR_DB_PORT" => "5432",
             "CURATOR_FLASK_SECRET_KEY" => "secret-key",
